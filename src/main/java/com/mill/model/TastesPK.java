 ...
 */
@Embeddable
public class TastesPK implements Serializable {
    ...
    public TastesPK(int usersIdusers, int productsIdproducts)
    {
    ...
    public boolean equals(Object object)
    {
        ...
        if (!(object instanceof TastesPK))
        {
            return false;
        }
        TastesPK other = (TastesPK) object;
    ...
    {
        return "com.mill.model.TastesPK[ usersIdusers=" + usersIdusers + ", productsIdproducts=" + productsIdproducts + " ]";
    }
